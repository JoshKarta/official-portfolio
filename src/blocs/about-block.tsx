...
export default function AboutBlock() {
    return (
        <div id="about" className="w-full dark:bg-black bg-white  dark:bg-grid-white/[0.1] bg-grid-black/[0.1] relative flex flex-col items-center justify-center py-16">
